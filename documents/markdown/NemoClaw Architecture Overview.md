...
![NemoClaw High-Level Component Diagram](https://files.buildwithfern.com/nvidia-nemoclaw.docs.buildwithfern.com/nemoclaw/3ef3064d733285f72015709b02136771338cc2f3d6535d0818c4991a99ebd2a9/_dot_dot_/docs/about/images/nemoclaw-highlevel-component-diagram.png)
...
For details on the baseline rules, refer to [Network Policies](/reference/network-policies). For container-level hardening, refer to [Sandbox Hardening](/deployment/sandbox-hardening).
