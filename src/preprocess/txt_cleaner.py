...
class TextCleaner:
    def __init__(self):
        # Remove bracketed footnotes e.g., [1], [12][13], [22]
        self.CITATION_PATTERN = re.compile(r"\[\d+\]")
        
        # Catch formatting typography (hair spaces, special dashes)
        ...
        # Match exactly 3 or more consecutive newlines to squeeze them down
